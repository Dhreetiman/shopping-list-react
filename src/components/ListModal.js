...
function GenerateList() {
  html2canvas(document.querySelector("#ListCapture")).then((canvas) => {
    ...
    pdf.save('Shopping-list-001.pdf');
  });
}
        ...
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="ListCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              <div className="w-100">
                <h4 className="fw-bold my-2">{this.props.info.ListForm||'Dhreetiman'}</h4>
                <h6 className="fw-bold text-secondary mb-1">
                  List #: {this.props.info.ListNumber||''}
                </h6>
              </div>
            ...
            <div className="p-4">
              <Row className="mb-4">
                <Col md={4}>
                  <div className="fw-bold">List Form:</div>
                  <div>{this.props.info.ListForm||''}</div>
                  <div>{this.props.info.listFormEmail||''}</div>
                </Col>
                <Col md={4}>
          ...
          <div className="pb-4 px-4">
            <Row>
              ...
              <Col md={6}>
                <Button variant="outline-primary" className="d-block w-100 mt-3 mt-md-0" onClick={GenerateList}>
